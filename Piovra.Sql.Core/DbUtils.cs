...
namespace Piovra.Sql.Core {
    public static class DbUtils {
        public static ParseConnectionStringResult ParseConnectionString(string connectionString) {
            var res = new ParseConnectionStringResult();
        ...
        public class ParseConnectionStringResult {
